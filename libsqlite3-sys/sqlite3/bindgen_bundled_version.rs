...
pub const SQLITE_VERSION: &[u8; 7usize] = b"3.49.1\0";
...
fn bindgen_test_layout_sqlite3_module() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<sqlite3_module>())).xIntegrity as *const _ as usize },
        192usize,
        concat!(
            "Offset of field: ",
            stringify!(sqlite3_module),
...
fn bindgen_test_layout_Fts5ExtensionApi() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Fts5ExtensionApi>())).xQueryToken as *const _ as usize },
        160usize,
        concat!(
            "Offset of field: ",
            stringify!(Fts5ExtensionApi),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Fts5ExtensionApi>())).xInstToken as *const _ as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(Fts5ExtensionApi),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Fts5ExtensionApi>())).xColumnLocale as *const _ as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(Fts5ExtensionApi),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Fts5ExtensionApi>())).xTokenize_v2 as *const _ as usize },
        184usize,
        concat!(
            "Offset of field: ",
            stringify!(Fts5ExtensionApi),
...
fn bindgen_test_layout_fts5_tokenizer_v2() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<fts5_tokenizer_v2>())).iVersion as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<fts5_tokenizer_v2>())).xCreate as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(fts5_tokenizer_v2),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<fts5_tokenizer_v2>())).xDelete as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(fts5_tokenizer_v2),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<fts5_tokenizer_v2>())).xTokenize as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(fts5_tokenizer_v2),
...
fn bindgen_test_layout_fts5_api() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<fts5_api>())).xCreateTokenizer_v2 as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(fts5_api),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<fts5_api>())).xFindTokenizer_v2 as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(fts5_api),
